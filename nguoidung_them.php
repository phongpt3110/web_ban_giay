        ...
        <div class="col-md-12">
            <div class="row align-items-center">
                ...
                <form action="" method="">
                    <!-- Nhập tên hiển thị -->
                    <div class="mb-3 mt-3">
                        <input type="email" class="form-control" id="email" placeholder="Tên người dùng"
                            name="TenNguoiDung">
                    </div>
                    <!-- Nhập tên tài khoản -->
                    ...
                    <!-- Nhập password -->
                    <div class="input-group mb-3">
                        <input type="password" name="MatKhauXacNhan" class="form-control form-control-lg bg-light fs-6"
                            placeholder="Xác nhận mật khẩu">
                    </div>
                    <!-- Bấm đăng nhập -->
                    <div class="input-group mb-3 justify-content-center">
                        <input type="submit" name="Submit" class="btn btn-lg btn-primary w-50 fs-6" value="ĐĂNG KÝ" />
                    </div>
                </form>
            </div>
        </div>
